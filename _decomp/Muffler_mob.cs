...
{
	[ObfuscatedName("Muffler_mob/<Wait1>d__23")]
	public sealed class _Wait1_d__23 : Il2CppSystem.Object
	{
		...
		public unsafe Muffler_mob __4__this
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr___4__this);
				System.IntPtr intPtr = *(System.IntPtr*)num;
				return (intPtr != (System.IntPtr)0) ? new Muffler_mob(intPtr) : null;
			}
			set
			{
				System.IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11315, XrefRangeEnd = 11316, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11316, XrefRangeEnd = 11321, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		static _Wait1_d__23()
		{
			Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "<Wait1>d__23");
			...
			NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr, 100664263);
			NativeMethodInfoPtr_System_IDisposable_Dispose_Private_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr, 100664264);
			NativeMethodInfoPtr_MoveNext_Private_Virtual_Final_New_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr, 100664265);
			NativeMethodInfoPtr_System_Collections_Generic_IEnumerator_System_Object__get_Current_Private_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr, 100664266);
			NativeMethodInfoPtr_System_Collections_IEnumerator_Reset_Private_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr, 100664267);
			NativeMethodInfoPtr_System_Collections_IEnumerator_get_Current_Private_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait1_d__23>.NativeClassPtr, 100664268);
		}
	...
	[ObfuscatedName("Muffler_mob/<Wait2>d__24")]
	public sealed class _Wait2_d__24 : Il2CppSystem.Object
	{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11322, XrefRangeEnd = 11327, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe void System_Collections_IEnumerator_Reset()
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
			System.IntPtr* param = null;
		...
		static _Wait2_d__24()
		{
			Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "<Wait2>d__24");
			...
			NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr, 100664269);
			NativeMethodInfoPtr_System_IDisposable_Dispose_Private_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr, 100664270);
			NativeMethodInfoPtr_MoveNext_Private_Virtual_Final_New_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr, 100664271);
			NativeMethodInfoPtr_System_Collections_Generic_IEnumerator_System_Object__get_Current_Private_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr, 100664272);
			NativeMethodInfoPtr_System_Collections_IEnumerator_Reset_Private_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr, 100664273);
			NativeMethodInfoPtr_System_Collections_IEnumerator_get_Current_Private_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_Wait2_d__24>.NativeClassPtr, 100664274);
		}
	...
	[System.Obsolete("Use Il2CppType.Of<T>() instead. This will be removed in a future version of unhollower.")]
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr));
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 11365, RefRangeEnd = 11366, XrefRangeStart = 11327, XrefRangeEnd = 11365, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11366, XrefRangeEnd = 11419, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11419, XrefRangeEnd = 11420, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11420, XrefRangeEnd = 11451, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 11500, RefRangeEnd = 11501, XrefRangeStart = 11451, XrefRangeEnd = 11500, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11501, XrefRangeEnd = 11550, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11550, XrefRangeEnd = 11553, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11553, XrefRangeEnd = 11556, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 11556, XrefRangeEnd = 11559, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(/*Could not decode attribute arguments.*/)]
	public unsafe Muffler_mob()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static Muffler_mob()
	{
		Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "Muffler_mob");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr);
		NativeFieldInfoPtr_res = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "res");
		NativeFieldInfoPtr_masterVolume = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "masterVolume");
		NativeFieldInfoPtr_audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "audioMixer");
		NativeFieldInfoPtr__audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "_audioMixer");
		NativeFieldInfoPtr_pitchMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "pitchMultiplier");
		NativeFieldInfoPtr_playTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "playTime");
		NativeFieldInfoPtr_playTime_ = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "playTime_");
		NativeFieldInfoPtr_offClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "offClip");
		NativeFieldInfoPtr_onClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "onClip");
		NativeFieldInfoPtr_offLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "offLoop");
		NativeFieldInfoPtr_onLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "onLoop");
		NativeFieldInfoPtr_mufflerOffVolCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "mufflerOffVolCurve");
		NativeFieldInfoPtr_mufflerOnVolCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "mufflerOnVolCurve");
		NativeFieldInfoPtr_clipsValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "clipsValue");
		NativeFieldInfoPtr_oneShotController = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "oneShotController");
		NativeFieldInfoPtr__playtime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, "_playtime");
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664253);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664254);
		NativeMethodInfoPtr_OnEnable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664255);
		NativeMethodInfoPtr_OnDisable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664256);
		NativeMethodInfoPtr_CreateOff_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664257);
		NativeMethodInfoPtr_CreateOn_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664258);
		NativeMethodInfoPtr_UpdateWaitTime_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664259);
		NativeMethodInfoPtr_Wait1_Private_IEnumerator_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664260);
		NativeMethodInfoPtr_Wait2_Private_IEnumerator_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664261);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Muffler_mob>.NativeClassPtr, 100664262);
	}

	public Muffler_mob(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
