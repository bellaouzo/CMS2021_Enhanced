...
[System.Serializable]
public class Livery : Il2CppSystem.Object
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<Livery>.NativeClassPtr));
	...
	public unsafe Livery()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Livery>.NativeClassPtr))
	{
	...
	static Livery()
	{
		Il2CppClassPointerStore<Livery>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "Livery");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Livery>.NativeClassPtr);
		NativeFieldInfoPtr_Name = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Livery>.NativeClassPtr, "Name");
		NativeFieldInfoPtr_CarID = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Livery>.NativeClassPtr, "CarID");
		NativeFieldInfoPtr_PathToFile = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Livery>.NativeClassPtr, "PathToFile");
		NativeFieldInfoPtr_texture = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Livery>.NativeClassPtr, "texture");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Livery>.NativeClassPtr, 100668658);
	}

	public Livery(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
