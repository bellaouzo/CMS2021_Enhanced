...
public class SuperCharger_mobile : MonoBehaviour
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr));
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 14265, RefRangeEnd = 14266, XrefRangeStart = 14242, XrefRangeEnd = 14265, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14266, XrefRangeEnd = 14268, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14268, XrefRangeEnd = 14269, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14269, XrefRangeEnd = 14270, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 14301, RefRangeEnd = 14303, XrefRangeStart = 14270, XrefRangeEnd = 14301, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14303, XrefRangeEnd = 14348, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14348, XrefRangeEnd = 14393, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe SuperCharger_mobile()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static SuperCharger_mobile()
	{
		Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "SuperCharger_mobile");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr);
		NativeFieldInfoPtr_res = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "res");
		NativeFieldInfoPtr_masterVolume = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "masterVolume");
		NativeFieldInfoPtr_audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "audioMixer");
		NativeFieldInfoPtr__audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "_audioMixer");
		NativeFieldInfoPtr_chargerOnLoopClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "chargerOnLoopClip");
		NativeFieldInfoPtr_chargerOffLoopClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "chargerOffLoopClip");
		NativeFieldInfoPtr_chargerVolCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "chargerVolCurve");
		NativeFieldInfoPtr_chargerPitchCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "chargerPitchCurve");
		NativeFieldInfoPtr_chargerOnLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "chargerOnLoop");
		NativeFieldInfoPtr_chargerOffLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "chargerOffLoop");
		NativeFieldInfoPtr_clipsValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, "clipsValue");
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664390);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664391);
		NativeMethodInfoPtr_OnEnable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664392);
		NativeMethodInfoPtr_OnDisable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664393);
		NativeMethodInfoPtr_DestroyAll_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664394);
		NativeMethodInfoPtr_CreateChargerOn_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664395);
		NativeMethodInfoPtr_CreateChargerOff_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664396);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuperCharger_mobile>.NativeClassPtr, 100664397);
	}

	public SuperCharger_mobile(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
