...
public class TextData : MonoBehaviour
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<TextData>.NativeClassPtr));
	...
	public unsafe TextData()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TextData>.NativeClassPtr))
	{
	...
	static TextData()
	{
		Il2CppClassPointerStore<TextData>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "TextData");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<TextData>.NativeClassPtr);
		NativeFieldInfoPtr_StatisticsFile = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TextData>.NativeClassPtr, "StatisticsFile");
		NativeFieldInfoPtr_AchievementsFile = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TextData>.NativeClassPtr, "AchievementsFile");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TextData>.NativeClassPtr, 100664541);
	}

	public TextData(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
