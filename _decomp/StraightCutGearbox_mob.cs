...
public class StraightCutGearbox_mob : MonoBehaviour
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr));
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 13505, RefRangeEnd = 13506, XrefRangeStart = 13482, XrefRangeEnd = 13505, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13506, XrefRangeEnd = 13508, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13508, XrefRangeEnd = 13509, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13509, XrefRangeEnd = 13510, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 13571, RefRangeEnd = 13573, XrefRangeStart = 13510, XrefRangeEnd = 13571, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13573, XrefRangeEnd = 13618, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13618, XrefRangeEnd = 13663, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13663, XrefRangeEnd = 13708, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13708, XrefRangeEnd = 13753, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe StraightCutGearbox_mob()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static StraightCutGearbox_mob()
	{
		Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "StraightCutGearbox_mob");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr);
		NativeFieldInfoPtr_res = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "res");
		NativeFieldInfoPtr_clipsValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "clipsValue");
		NativeFieldInfoPtr_masterVolume = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "masterVolume");
		NativeFieldInfoPtr_audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "audioMixer");
		NativeFieldInfoPtr__audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "_audioMixer");
		NativeFieldInfoPtr_onLoopClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "onLoopClip");
		NativeFieldInfoPtr_offLoopClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "offLoopClip");
		NativeFieldInfoPtr_oneShotOnClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "oneShotOnClip");
		NativeFieldInfoPtr_oneShotOffClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "oneShotOffClip");
		NativeFieldInfoPtr_loopVolCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "loopVolCurve");
		NativeFieldInfoPtr_loopPitchCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "loopPitchCurve");
		NativeFieldInfoPtr_minDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "minDistance");
		NativeFieldInfoPtr_maxDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "maxDistance");
		NativeFieldInfoPtr_onLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "onLoop");
		NativeFieldInfoPtr_offLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "offLoop");
		NativeFieldInfoPtr_oneShotOn = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "oneShotOn");
		NativeFieldInfoPtr_oneShotOff = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "oneShotOff");
		NativeFieldInfoPtr_pedalPressedDown = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "pedalPressedDown");
		NativeFieldInfoPtr_pedalReleased = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, "pedalReleased");
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664355);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664356);
		NativeMethodInfoPtr_OnEnable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664357);
		NativeMethodInfoPtr_OnDisable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664358);
		NativeMethodInfoPtr_DestroyAll_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664359);
		NativeMethodInfoPtr_CreateOnLoop_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664360);
		NativeMethodInfoPtr_CreateOffLoop_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664361);
		NativeMethodInfoPtr_CreateOneShotOn_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664362);
		NativeMethodInfoPtr_CreateOneShotOff_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664363);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StraightCutGearbox_mob>.NativeClassPtr, 100664364);
	}

	public StraightCutGearbox_mob(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
