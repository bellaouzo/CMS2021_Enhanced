...
public class BasicInventoryItem : MonoBehaviour
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr));
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 150919, XrefRangeEnd = 150920, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 150920, XrefRangeEnd = 150921, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 150935, RefRangeEnd = 150938, XrefRangeStart = 150921, XrefRangeEnd = 150935, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(/*Could not decode attribute arguments.*/)]
	public unsafe BasicInventoryItem()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static BasicInventoryItem()
	{
		Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "CMS.UI", "BasicInventoryItem");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr);
		NativeFieldInfoPtr_ButtonAction = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, "ButtonAction");
		NativeFieldInfoPtr_inventoryItem = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, "inventoryItem");
		NativeFieldInfoPtr_condition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, "condition");
		NativeFieldInfoPtr_selected = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, "selected");
		NativeMethodInfoPtr_OnPointerEnter_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, 100673799);
		NativeMethodInfoPtr_OnPointerExit_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, 100673800);
		NativeMethodInfoPtr_OnDisable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, 100673801);
		NativeMethodInfoPtr_EnableSelection_Private_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, 100673802);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BasicInventoryItem>.NativeClassPtr, 100673803);
	}

	public BasicInventoryItem(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
