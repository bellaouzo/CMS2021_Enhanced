...
public class SuspensionTravelChart : PerformanceChart
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr));

	public unsafe Il2CppReferenceArray<DataLogger.Channel> m_wheels
	{
		get
		{
			...
			return (intPtr != (System.IntPtr)0) ? new Il2CppReferenceArray<DataLogger.Channel>(intPtr) : null;
		}
		set
		{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 126535, XrefRangeEnd = 126537, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 126537, XrefRangeEnd = 126565, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 126565, XrefRangeEnd = 126567, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 126567, XrefRangeEnd = 126570, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe SuspensionTravelChart()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static SuspensionTravelChart()
	{
		Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "VehiclePhysics", "SuspensionTravelChart");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr);
		NativeFieldInfoPtr_m_wheels = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, "m_wheels");
		NativeFieldInfoPtr_m_speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, "m_speed");
		NativeMethodInfoPtr_Title_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, 100671779);
		NativeMethodInfoPtr_Initialize_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, 100671780);
		NativeMethodInfoPtr_ResetView_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, 100671781);
		NativeMethodInfoPtr_SetupChannels_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, 100671782);
		NativeMethodInfoPtr_RecordData_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, 100671783);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SuspensionTravelChart>.NativeClassPtr, 100671784);
	}

	public SuspensionTravelChart(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
