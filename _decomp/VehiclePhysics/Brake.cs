...
public class Brake : Block
{
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<Brake>.NativeClassPtr));
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 124333, XrefRangeEnd = 124339, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 124339, XrefRangeEnd = 124341, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 124341, XrefRangeEnd = 124346, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 124346, XrefRangeEnd = 124349, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe Brake()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Brake>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static Brake()
	{
		Il2CppClassPointerStore<Brake>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "VehiclePhysics", "Brake");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Brake>.NativeClassPtr);
		NativeFieldInfoPtr_brakeInput = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Brake>.NativeClassPtr, "brakeInput");
		NativeFieldInfoPtr_maxBrakeTorque = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Brake>.NativeClassPtr, "maxBrakeTorque");
		NativeFieldInfoPtr_m_input = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Brake>.NativeClassPtr, "m_input");
		NativeFieldInfoPtr_m_output = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Brake>.NativeClassPtr, "m_output");
		NativeMethodInfoPtr_Initialize_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Brake>.NativeClassPtr, 100671405);
		NativeMethodInfoPtr_CheckConnections_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Brake>.NativeClassPtr, 100671406);
		NativeMethodInfoPtr_ComputeStateUpstream_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Brake>.NativeClassPtr, 100671407);
		NativeMethodInfoPtr_EvaluateTorqueDownstream_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Brake>.NativeClassPtr, 100671408);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Brake>.NativeClassPtr, 100671409);
	}

	public Brake(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
