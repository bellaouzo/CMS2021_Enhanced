...
{
	[ObfuscatedName("TurboCharger/<WaitForStart>d__24")]
	public sealed class _WaitForStart_d__24 : Il2CppSystem.Object
	{
		...
		public unsafe TurboCharger __4__this
		{
			get
			{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14393, XrefRangeEnd = 14394, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14394, XrefRangeEnd = 14399, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		{
			Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "<WaitForStart>d__24");
			...
			NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr, 100664408);
			NativeMethodInfoPtr_System_IDisposable_Dispose_Private_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr, 100664409);
			NativeMethodInfoPtr_MoveNext_Private_Virtual_Final_New_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr, 100664410);
			NativeMethodInfoPtr_System_Collections_Generic_IEnumerator_System_Object__get_Current_Private_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr, 100664411);
			NativeMethodInfoPtr_System_Collections_IEnumerator_Reset_Private_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr, 100664412);
			NativeMethodInfoPtr_System_Collections_IEnumerator_get_Current_Private_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<_WaitForStart_d__24>.NativeClassPtr, 100664413);
		}
	...
	private static readonly System.IntPtr NativeFieldInfoPtr_longShotClips;

	private static readonly System.IntPtr NativeFieldInfoPtr_shortShotClips;
	...
	[System.Obsolete("Use Il2CppType.Of<T>() instead. This will be removed in a future version of unhollower.")]
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr));
	...
	public unsafe Il2CppReferenceArray<AudioClip> longShotClips
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_longShotClips);
			System.IntPtr intPtr = *(System.IntPtr*)num;
		...
		{
			System.IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_longShotClips), IL2CPP.Il2CppObjectBaseToPtr(obj));
		}
	}

	public unsafe Il2CppReferenceArray<AudioClip> shortShotClips
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_shortShotClips);
			System.IntPtr intPtr = *(System.IntPtr*)num;
			return (intPtr != (System.IntPtr)0) ? new Il2CppReferenceArray<AudioClip>(intPtr) : null;
		}
		set
		{
			System.IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_shortShotClips), IL2CPP.Il2CppObjectBaseToPtr(obj));
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14399, XrefRangeEnd = 14494, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14494, XrefRangeEnd = 14497, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14497, XrefRangeEnd = 14498, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14498, XrefRangeEnd = 14502, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 14548, RefRangeEnd = 14550, XrefRangeStart = 14502, XrefRangeEnd = 14548, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14550, XrefRangeEnd = 14553, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14553, XrefRangeEnd = 14602, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14602, XrefRangeEnd = 14632, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14632, XrefRangeEnd = 14681, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14681, XrefRangeEnd = 14684, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TurboCharger()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static TurboCharger()
	{
		Il2CppClassPointerStore<TurboCharger>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "TurboCharger");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr);
		NativeFieldInfoPtr_res = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "res");
		NativeFieldInfoPtr_clipsValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "clipsValue");
		NativeFieldInfoPtr_masterVolume = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "masterVolume");
		NativeFieldInfoPtr_audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "audioMixer");
		NativeFieldInfoPtr__audioMixer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "_audioMixer");
		NativeFieldInfoPtr_turboLoopClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "turboLoopClip");
		NativeFieldInfoPtr_maxRpmLoopClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "maxRpmLoopClip");
		NativeFieldInfoPtr_chargerVolCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "chargerVolCurve");
		NativeFieldInfoPtr_chargerPitchCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "chargerPitchCurve");
		NativeFieldInfoPtr_longShotTreshold = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "longShotTreshold");
		NativeFieldInfoPtr_longShotClips = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "longShotClips");
		NativeFieldInfoPtr_shortShotClips = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "shortShotClips");
		NativeFieldInfoPtr_oneShotVolCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "oneShotVolCurve");
		NativeFieldInfoPtr_oneShotPitchCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "oneShotPitchCurve");
		NativeFieldInfoPtr_turboLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "turboLoop");
		NativeFieldInfoPtr_oneShot = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "oneShot");
		NativeFieldInfoPtr_maxTurboLoop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "maxTurboLoop");
		NativeFieldInfoPtr_oneShotController = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "oneShotController");
		NativeFieldInfoPtr__playtime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, "_playtime");
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664398);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664399);
		NativeMethodInfoPtr_OnDisable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664400);
		NativeMethodInfoPtr_OnEnable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664401);
		NativeMethodInfoPtr_DestroyAll_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664402);
		NativeMethodInfoPtr_WaitForStart_Private_IEnumerator_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664403);
		NativeMethodInfoPtr_CreateTurboLoop_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664404);
		NativeMethodInfoPtr_CreateOneShot_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664405);
		NativeMethodInfoPtr_CreateMaxTurboLoop_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664406);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TurboCharger>.NativeClassPtr, 100664407);
	}

	public TurboCharger(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
