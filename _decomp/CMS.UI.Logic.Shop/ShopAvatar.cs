...
public class ShopAvatar : GridItem
{
	private static readonly System.IntPtr NativeFieldInfoPtr_ShopType;

	private static readonly System.IntPtr NativeFieldInfoPtr_ShopState;
	...
	private static readonly System.IntPtr NativeMethodInfoPtr_SetShopState_Public_Void_ShopState_0;
	...
	public new static Il2CppSystem.Type Il2CppType => Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr));
	...
	public unsafe ShopState ShopState
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ShopState);
			return *(ShopState*)num;
		}
		set
		{
			*(ShopState*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ShopState)) = shopState;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 189323, XrefRangeEnd = 189325, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 189325, XrefRangeEnd = 189326, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 189326, XrefRangeEnd = 189327, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 189341, RefRangeEnd = 189344, XrefRangeStart = 189327, XrefRangeEnd = 189341, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 189350, RefRangeEnd = 189353, XrefRangeStart = 189344, XrefRangeEnd = 189350, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SetShopState(ShopState newState)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
		System.IntPtr* ptr = stackalloc System.IntPtr[1];
		*ptr = (nint)(&newState);
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetShopState_Public_Void_ShopState_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref exc);
		Il2CppException.RaiseExceptionIfNecessary(exc);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 189353, XrefRangeEnd = 189354, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe ShopAvatar()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static ShopAvatar()
	{
		Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "CMS.UI.Logic.Shop", "ShopAvatar");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr);
		NativeFieldInfoPtr_ShopType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, "ShopType");
		NativeFieldInfoPtr_ShopState = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, "ShopState");
		NativeFieldInfoPtr_Selected = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, "Selected");
		NativeFieldInfoPtr_OnMouseClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, "OnMouseClick");
		NativeFieldInfoPtr_locked = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, "locked");
		NativeMethodInfoPtr_OnPointerEnter_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677255);
		NativeMethodInfoPtr_OnPointerClick_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677256);
		NativeMethodInfoPtr_Select_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677257);
		NativeMethodInfoPtr_Deselect_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677258);
		NativeMethodInfoPtr_OnDisable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677259);
		NativeMethodInfoPtr_EnableSelection_Private_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677260);
		NativeMethodInfoPtr_SetShopState_Public_Void_ShopState_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677261);
		NativeMethodInfoPtr_CanSelect_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677262);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopAvatar>.NativeClassPtr, 100677263);
	}

	public ShopAvatar(System.IntPtr P_0)
		: base(P_0)
	{
	}
}
