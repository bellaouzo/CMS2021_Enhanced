...
using CMS.Platforms.XboxGameCore;
using Il2CppSystem;
...
public class AccountStats : Il2CppSystem.Object
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 227313, XrefRangeEnd = 227321, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AccountStats(CMS.Platforms.XboxGameCore.AccountStats gdkStats)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AccountStats>.NativeClassPtr))
	{
		System.IntPtr* ptr = stackalloc System.IntPtr[1];
		*ptr = IL2CPP.Il2CppObjectBaseToPtr(gdkStats);
	...
	static AccountStats()
	{
		Il2CppClassPointerStore<AccountStats>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "CMS.Platforms.Xbox", "AccountStats");
		...
		NativeMethodInfoPtr__ctor_Public_Void_AccountStats_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AccountStats>.NativeClassPtr, 100680372);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AccountStats>.NativeClassPtr, 100680373);
	}
